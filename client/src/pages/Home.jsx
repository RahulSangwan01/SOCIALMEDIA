...
// import { apiRequest, deletePost, fetchPosts, getUserInfo, handleFileUpload, likePost, sendFriendRequest } from "../utils"; 
// import { UserLogin } from "../redux/userSlice";
// import { SetSuggestedFriends } from "../redux/userSlice"; // Import the SetSuggestedFriends action

// const Home = () => {
//   const { user, edit } = useSelector((state) => state.user);
//   const { posts } = useSelector(state => state.posts);
//   const { suggestedFriends } = useSelector((state) => state.user); // Get suggested friends from Redux store
//   const [friendRequest, setFriendRequest] = useState([]);
//   const [errMsg, setErrMsg] = useState("");
//   const [file, setFile] = useState(null);
//   const [posting, setPosting] = useState(false);
...
//         method: "POST",
//       });
//       // Dispatch the suggested friends to Redux store
...
//     fetchPost();
//     fetchFriendRequests();
//     fetchSuggestedFriends(); // Fetch suggested friends from the API
//   }, []);
...
//                 <label className='flex items-center gap-1 text-base text-ascent-2 hover:text-ascent-1 cursor-pointer' htmlFor='vgifUpload'>
//                   <input
//                     type='file'
//                     data-max-size='5120'
//                     onChange={(e) => setFile(e.target.files[0])}
...
//                 <Link to='/friends' className='text-sm font-semibold text-ascent-1'>
//                   See All
//                 </Link>
//               </div>
...
//                       <button
//                         onClick={() => handleFriendRequest(friend?._id)}
//                         className='flex items-center gap-1 bg-primary border text-sm rounded-lg p-2'
//                       >
//                         <BsPersonFillAdd />
//                         Add
//                       </button>
